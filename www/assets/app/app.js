...
((ng, navigator, moment, marked, jQuery, gapi) => {
  ...
  ng.module('mainApp')
    ...
    .constant('$gapi' , gapi)
    .config(['$interpolateProvider', _$interpolateProvider])
  ...
  function configRoutes($routeProvider) {
    ...
    var rankingRouteMobileData = {
      'templateUrl': '/assets/app/templates/ranking.mobile.html',
    ...
    var characterInfoRouteData = {
      'templateUrl': '/assets/app/templates/characterInfo.html',
    ...
    var characterInfoMobileRouteData = {
      'templateUrl': '/assets/app/templates/characterInfo.mobile.html',
      'controller': 'mainApp.characterInfo.controller',
      resolve: {
        'characterInfo': ['$hs', '$route', function($hs, $route){
          return $hs
    ...
    var twitchChannelsRouteData = {
      'templateUrl': '/assets/app/templates/twitchChannels.html',
    ...
    //404 route
    var _404RouteData = {
      'templateUrl': '/assets/app/templates/404.html',
    };
